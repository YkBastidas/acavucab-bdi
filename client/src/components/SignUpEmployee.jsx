...
class SignUpEmployee extends Component{
  ...
  render(){
    ...
    this.OptionRoles = Object.values(this.state.rol).map((rol, key)=>
          rol.clave
          ? <option key={rol.clave} value={rol.nombre}> {rol.nombre}</option>
          : "")
    return(
      <div className="row align-items-center justify-content-center">
        <div className="col-6 text-center bg-secondary text-white rounded-pill margin-bottom">
          <h4>
            <button className="btn btn-link" onClick={this.props.onClickNatural}>
              Persona Natural
            </button>
          </h4>
        </div>
        <div className="col-6 text-center bg-secondary text-dark rounded-pill margin-bottom">
          <h4>
            <button className="btn btn-link" onClick={this.props.onClickJuridico}>
              Persona Jurídica
            </button>
          </h4>
        </div>
        ...
        <div className="col-12 margin-top">
          <form onSubmit={this.props.handleSubmit} className="needs-validation formulary">
            <h4 className="text-center"> Datos del Empleado </h4>
            <div className="form-row">
              ...
              <div className="col-md-2 mb-3">
                ...
                <select className="custom-select" id="rol" name="rol" required
           ...
           <div className="form-row">
             ...
             <div className="col-md-3 mb-3">
               <Input title={"* Cargo:"} name={"cargo"} inputtype={"text"} value={this.props.data.cargo} handlerChange={this.props.handleInput} required={"required"}/>
             </div>
             <div className="col-md-2 mb-3">
               <Currency title={"* Salario"} name={"salario"} inputtype={"number"} value={this.props.data.salario} handlerChange={this.props.handleInput} help="true" helptext="Ej: '125000,00' utilice la coma ',' para los decimales"/>
             </div>
             <div className="col-md-3 mb-3">
